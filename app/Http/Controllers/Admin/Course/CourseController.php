    ...
    public function branchList()
    {
        ...
        return datatables()->of($query->get())
            ...
            ->addColumn('action', function ($row) {
                $btn = '<a href="' . route('course.edit', ['id' => encrypt($row->id)]) . '" target="_blank" class="btn btn-primary">Edit</a><a href="' . route('course.destroy', ['id' => encrypt($row->id)]) . '" class="btn btn-danger">Delete</a>';
                if ($row->status == '1') {
