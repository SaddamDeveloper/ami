...
<div class="breadcrumb_bg">
    ...
    <ul class="breadcrumb breadcrumb-arrow">
        ...
        <li class="active"><span>Admission</span></li>
    </ul>
    </div>
</div>
<section style="margin-bottom: 200px;">
    <div class="container">
        ...
        <div class="well">
            ...
            <div class="form-row mb-3 qualification">
                ...
                <div class="col-md-2 col-sm-12 col-xs-12 mb-3">
                    <button class="btn btn-primary btn-rounded" id="addMore" style="margin-top: 31px;"> 
        ...
        <div class="well">
            <h3>Upload necessary Documents (Aadhar Card, PAN Card)</h3>
            <div id="file_options" class="input_fields_wrap">
                <div class="form-row mb-10">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <a id="file_more" class="btn btn-success" style="margin-top: 31px;"><i class="fa fa-plus"></i></a>
                        {{-- <a id="remove_file" class="btn btn-danger"><i class="fa fa-trash"></i></a> --}}
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function(){
        ...
        var container = $(".qualification"); //Fields container
        var add = $("#addMore"); //Add button ID
        ...
        $(add).click(function(e){ 
            ...
            if(y < max){ //max input box allowed
                ...
                $(container).append(`<div class="form-row mb-10"><div class="col-md-3 col-sm-12 col-xs-12 mb-3">
                            <label for="exam_passed">Exam Passed</label>
        ...
        var add_button      = $("#file_more"); //Add button ID
        ...
        $(add_button).click(function(e){ 
            ...
            if(x < max_fields){ //max input box allowed
                ...
                $(wrapper).append(`<div class="form-row mb-10"><div class="col-md-4 col-sm-12 col-xs-12">
                        <label for="">File Input</label> 
                        <input type="file" id="" class="form-control" placeholder="Signature of parent\'s/guardian">
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <label for="">Document Name</label> 
                        <input type="text" id="" class="form-control" placeholder="Enter document name">
                    </div>
                    <div class="remove_field col-md-4 col-sm-12 col-xs-12 mb-3">
                        <button class="btn btn-danger" style="margin-top:24px"><i class="fa fa-trash"></i></button>
                    </div></div>`);
            }
        });
